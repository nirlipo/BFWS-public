...
BFWS::BFWS()
	: STRIPS_Problem(), m_log_filename( "de.log"), m_plan_filename( "plan.ipc" ), m_M(32), m_max_novelty(2), m_anytime(false), m_found_plan(false), m_cost(infty), m_cost_bound(infty) {
}

BFWS::BFWS( std::string domain_file, std::string instance_file )
	: STRIPS_Problem( domain_file, instance_file ), m_log_filename( "bfws.log" ), m_plan_filename( "plan.ipc" ), m_M(32), m_max_novelty(2), m_anytime(false), m_found_plan(false), m_cost(infty), m_cost_bound(infty) {
}
